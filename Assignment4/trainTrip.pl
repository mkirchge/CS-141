...
% Question 2
% Knowledge-base
%people(sue, f, yoga, chess, _).
%people(jim, m, chess, _, _).
%people(tom, m, run, yoga, _).
%people(joe, m, chess, run, _).
%people(cami, f, yoga, chess, run).
%people(bob, m, run, _, _).
%people(fay, f, yoga, run, chess).
%people(beth, f, chess, run, _).
